  ...
  const KindModeContent = ({ fileData, allFiles }) => {
    ...
    return /* @__PURE__ */ u2("div", { class: "markdown-preview-view markdown-rendered", children: /* @__PURE__ */ u2("div", { class: "wrap", children: [
      ...
      groups.map((g2, gi) => /* @__PURE__ */ u2("div", { children: [
        groups.length > 1 && /* @__PURE__ */ u2("h2", { id: `letter-${g2.letter}`, style: "font-family:'MyHand','Fraunces',serif; font-weight:normal; font-size:24px; color:var(--rubric); margin:2rem 0 0.6rem;", children: g2.letter }),
...
export { KindModeContent_default as KindModeContent };
